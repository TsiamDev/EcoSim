...
if __name__ == "__main__":
    ...
    cities_btns.append(tk.Button(top, text ="City " + str(0), command = lambda: OpenCityView(0)))
    cities_btns[0].pack()
    #for i in range(1, 5):
    cities_btns.append(tk.Button(top, text ="City " + str(1), command = lambda: OpenCityView(1)))
    cities_btns[1].pack()
    
    nt = tk.Button(top, text ="End Turn", command = NextTurn)
    nt.pack()
